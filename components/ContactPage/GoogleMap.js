...
const GoogleMap = () => {
  return (
    <>
      ...
      <div className="lest-contact text-center ml-2 mr-2 bg-black text-white h-80 relative md:flex md:justify-around lg:flex justify-around lg:h-10">
        <h2 className="text-2xl my-5 mx-3 p-4">
